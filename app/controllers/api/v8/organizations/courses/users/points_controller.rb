class Api::V8::Organizations::Courses::Users::PointsController < Api::V8::BaseController
  ...
  swagger_path '/api/v8/org/{organization_id}/courses/{course_name}/user/{user_id}/points' do
    operation :get do
  ...
  swagger_path '/api/v8/org/{organization_id}/courses/{course_name}/user/current/points' do
    operation :get do
