...
describe Assistantship, type: :model do
  ...
  it 'cant create assistantship if course is non-existant' do
  ...
  it 'leaves courses intact when user is destroyed, but courses dont have ghost assistants' do
    user = FactoryGirl.create :user
    course1 = FactoryGirl.create :course
    course2 = FactoryGirl.create :course
  ...
  it 'leaves assistants intact when course is destroyed, but users dont assist ghost courses' do
    course = FactoryGirl.create :course
    user1 = FactoryGirl.create :user
    user2 = FactoryGirl.create :user
