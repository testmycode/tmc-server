  ...
  describe 'As a teacher' do
    ...
    describe 'GET index' do
      it 'lists assistants in course' do
        ...
        get :index, organization_id: @organization.slug, course_id: @course.name
    ...
    describe 'POST create' do
      it 'with a valid username adds a new assistant' do
        expect do
          post :create, organization_id: @organization.slug, course_id: @course.name, username: @user.username
        end.to change(Assistantship, :count).by(1)
      end

      it 'with a invalid username doesn\'t add any assistants' do
        expect do
          post :create, organization_id: @organization.slug, course_id: @course.name, username: 'invalid'
    ...
    describe 'DELETE destroy' do
      it 'removes assistant' do
        ...
        expect do
          delete :destroy, organization_id: @organization.slug, course_id: @course.name, id: @assistantship.to_param
        end.to change(Assistantship, :count).by(-1)
      end
    end
  end
