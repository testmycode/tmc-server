//NOTE: this version has been slightly modified. Search for "MODIFICATION" below.
/*
	...
	$.fn.dropShadow = function(options)
	{
		...
		this.not(".dropShadow").each(function()
		{
			...
			if (jthis.css("position") != "absolute") {
				jthis.css({
          // MODIFICATION: commented out to permit the original element to be position: fixed
					//position: "relative",
