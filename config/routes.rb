...
resources :organizations, except: :destory, path: 'org' do
  ...
  get 'email_confirmation_request', to: 'email_confirmations#request_user_to_confirm_email', as: 'email_confirmation_request'
  post 'send_confirmation_mail', to: 'email_confirmations#send_confirmation_mail', as: 'send_confirmation_mail'
